...
class ValidCodeImg:
    ...
    def getValidCodeImg(self):
        ...
        font = ImageFont.truetype("corbel.ttf", size=self.font_size)
        # font = ImageFont.truetype(size=self.font_size)
        temp = []
        for i in range(self.code_count):
            ...
            draw.text((2 + i * 18, -2), random_char, self.getRandomColor(), font=font)
